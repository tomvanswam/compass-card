...
import type { CcElementEditor } from "./element-editor";
...
export class CcSubElementEditor extends LitElement {
  ...
  @query(".editor")
  private _editorElement?: CcElementEditor<LovelaceChipConfig>;
...
declare global {
  interface HTMLElementTagNameMap {
    "hui-sub-element-editor": CcSubElementEditor;
  }
}
