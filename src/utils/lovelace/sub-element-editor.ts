...
import type { compassElementEditor } from "./element-editor";
...
@customElement("cc-sub-element-editor")
export class compassSubElementEditor extends LitElement {
  ...
  @query(".editor")
  private _editorElement?: compassElementEditor<LovelaceChipConfig>;
...
declare global {
  interface HTMLElementTagNameMap {
    "hui-sub-element-editor": compassSubElementEditor;
  }
}
