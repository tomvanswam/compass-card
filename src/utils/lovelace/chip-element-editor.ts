...
import { compassElementEditor } from "./element-editor";
import { LovelaceChipEditor } from "./types";

@customElement("cc-chip-element-editor")
export class compassChipElementEditor extends compassElementEditor<LovelaceChipConfig> {
