...
export class compassButtonGroup extends LitElement {
  ...
  static get styles(): CSSResultGroup {
    return css`
      ...
      .container > ::slotted(compass-button) {
        width: 0;
        flex-grow: 0;
        flex-shrink: 1;
        flex-basis: calc(var(--control-height) * var(--control-button-ratio));
      }
      .container > ::slotted(compass-input-number) {
        width: 0;
        flex-grow: 0;
        flex-shrink: 1;
        flex-basis: calc(
      ...
      .container.fill > ::slotted(compass-button),
      .container.fill > ::slotted(compass-input-number) {
        flex-grow: 1;
      }
    `;
  }
