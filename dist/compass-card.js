 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,n){const o=t[0];if("."===o){return new W(e,t.slice(1),i).parts}if("@"===o)return[new $(e,t.slice(1),n.eventContext)];if("?"===o)return[new O(e,t.slice(1),i)];return new w(e,t,i).parts}handleTextExpression(e){return new x(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const D=(e,...t)=>new y(e,t,"html",T)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const ee={};class te extends L{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,i)=>e.reduceRight((e,i)=>Array.isArray(i)?t(i,e):(e.add(i),e),i),i=t(e,new Set),n=[];i.forEach(e=>n.unshift(e)),this._styles=n}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==ee&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return ee}}te.finalized=!0,te.render=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const o=n.scopeName,r=A.has(t),s=j&&11===t.nodeType&&!!t.host,a=s&&!Y.has(o),c=a?document.createDocumentFragment():t;if(((e,t,n)=>{let o=A.get(t);void 0===o&&(i(t,t.firstChild),A.set(t,o=new x(Object.assign({templateFactory:k},n))),o.appendInto(t)),o.setValue(e),o.commit()})(e,c,Object.assign({templateFactory:R(o)},n)),a){const e=A.get(c);A.delete(c);const n=e.value instanceof v?e.value.template:void 0;H(o,c,n),i(t,t.firstChild),t.appendChild(c),A.set(t,e)}!r&&s&&window.ShadyCSS.styleElement(t.host)};var ie=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,ne="[^\\s]+",oe=/\[([^]*?)\]/gm;function re(e,t){for(var i=[],n=0,o=e.length;n<o;n++)i.push(e[n].substr(0,t));return i}var se=function(e){return function(t,i){var n=i[e].map((function(e){return e.toLowerCase()})).indexOf(t.toLowerCase());return n>-1?n:null}};function ae(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];for(var n=0,o=t;n<o.length;n++){var r=o[n];for(var s in r)e[s]=r[s]}return e}var ce=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],de=["January","February","March","April","May","June","July","August","September","October","November","December"],le=re(de,3),ue={dayNamesShort:re(ce,3),dayNames:ce,monthNamesShort:le,monthNames:de,amPm:["am","pm"],DoFn:function(e){return e+["th","st","nd","rd"][e%10>3?0:(e-e%10!=10?1:0)*e%10]}},pe=ae({},ue),he=function(e,t){for(void 0===t&&(t=2),e=String(e);e.length<t;)e="0"+e;return e},fe={D:function(e){return String(e.getDate())},DD:function(e){return he(e.getDate())},Do:function(e,t){return t.DoFn(e.getDate())},d:function(e){return String(e.getDay())},dd:function(e){return he(e.getDay())},ddd:function(e,t){return t.dayNamesShort[e.getDay()]},dddd:function(e,t){return t.dayNames[e.getDay()]},M:function(e){return String(e.getMonth()+1)},MM:function(e){return he(e.getMonth()+1)},MMM:function(e,t){return t.monthNamesShort[e.getMonth()]},MMMM:function(e,t){return t.monthNames[e.getMonth()]},YY:function(e){return he(String(e.getFullYear()),4).substr(2)},YYYY:function(e){return he(e.getFullYear(),4)},h:function(e){return String(e.getHours()%12||12)},hh:function(e){return he(e.getHours()%12||12)},H:function(e){return String(e.getHours())},HH:function(e){return he(e.getHours())},m:function(e){return String(e.getMinutes())},mm:function(e){return he(e.getMinutes())},s:function(e){return String(e.getSeconds())},ss:function(e){return he(e.getSeconds())},S:function(e){return String(Math.round(e.getMilliseconds()/100))},SS:function(e){return he(Math.round(e.getMilliseconds()/10),2)},SSS:function(e){return he(e.getMilliseconds(),3)},a:function(e,t){return e.getHours()<12?t.amPm[0]:t.amPm[1]},A:function(e,t){return e.getHours()<12?t.amPm[0].toUpperCase():t.amPm[1].toUpperCase()},ZZ:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+he(100*Math.floor(Math.abs(t)/60)+Math.abs(t)%60,4)},Z:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+he(Math.floor(Math.abs(t)/60),2)+":"+he(Math.abs(t)%60,2)}},me=function(e){return+e-1},ge=[null,"[1-9]\\d?"],_e=[null,ne],ve=["isPm",ne,function(e,t){var i=e.toLowerCase();return i===t.amPm[0]?0:i===t.amPm[1]?1:null}],Se=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(e){var t=(e+"").match(/([+-]|\d\d)/gi);if(t){var i=60*+t[1]+parseInt(t[2],10);return"+"===t[0]?i:-i}return 0}],ye=(se("monthNamesShort"),se("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var Ne=function(e,t,i){if(void 0===t&&(t=ye.default),void 0===i&&(i={}),"number"==typeof e&&(e=new Date(e)),"[object Date]"!==Object.prototype.toString.call(e)||isNaN(e.getTime()))throw new Error("Invalid Date pass to format");var n=[];t=(t=ye[t]||t).replace(oe,(function(e,t){return n.push(t),"@@@"}));var o=ae(ae({},pe),i);return(t=t.replace(ie,(function(t){return fe[t](e,o)}))).replace(/@@@/g,(function(){return n.shift()}))},be=(function(){try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}}(),{version:"Version",description:"Show a compass with an indicator in the direction of the entity's value",invalid_configuration:"Invalid configuration",no_entity:"Entity not configured",offset_not_a_number:"Direction offset is not a number",invalid:"invalid",on:"On",off:"Off"}),we={name:"Name",optional:"Optional",entity:"Entity",required:"Required",primary:"Direction",secondary:"Secondary",indicator:"Indicator",direction:"Direction",offset:"Offset",show:"Show",abbreviations:"Abbreviations",toggle:"Toggle",language:"Language"},Ee={north:"North",east:"East",south:"South",west:"West",N:"N",NNE:"NNE",NE:"NE",ENE:"ENE",E:"E",ESE:"ESE",SE:"SE",SSE:"SSE",S:"S",SSW:"SSW",SW:"SW",WSW:"WSW",W:"W",WNW:"WNW",NW:"NW",NNW:"NNW"},xe={common:be,editor:we,directions:Ee},Oe=Object.freeze({__proto__:null,common:be,editor:we,directions:Ee,default:xe}),We={version:"Versie",description:"Toon een kompas met een pijl wijzend naar de waarde van de entity",invalid_configuration:"Foutieve configuratie",no_entity:"Entity niet geconfigureerd",offset_not_a_number:"Direction offset is geen nummer",invalid:"ongeldig",on:"Aan",off:"Uit"},Ce={name:"Naam",optional:"Optioneel",entity:"Entiteit",required:"Noodzakelijk",primary:"Richting",secondary:"Secundaire",indicator:"Wijzer",direction:"Richting",offset:"Afwijking",show:"Toon",abbreviations:"Afkorting",toggle:"Wissel",language:"Taal"},Pe={north:"Noorden",east:"Oosten",south:"Zuiden",west:"Westen",N:"N",NNE:"NNO",NE:"NO",ENE:"ONO",E:"O",ESE:"OZO",SE:"ZO",SSE:"ZZO",S:"Z",SSW:"ZZW",SW:"ZW",WSW:"WZW",W:"W",WNW:"WNW",NW:"NW",NNW:"NNW"},$e={common:We,editor:Ce,directions:Pe},Me=Object.freeze({__proto__:null,common:We,editor:Ce,directions:Pe,default:$e}),ke={version:"Versione",description:"Mostra una bussola con un indicatore nella direzione indicata dal valore dell'entità.",invalid_configuration:"Configurazione non valida",no_entity:"Entità non configurata",offset_not_a_number:"L'offset della direzione non è un numero.",invalid:"invalido",on:"Acceso",off:"Spento"},Ve={name:"Nome",optional:"Opzionale",entity:"Entità",required:"Richiesto",primary:"Direzione",secondary:"Secondario",indicator:"Indicatore",direction:"Direzione",offset:"Compensazione",show:"Mostra",abbreviations:"Abbreviazioni",toggle:"Inverti stato",language:"Lingua"},Ae={north:"Nord",east:"Est",south:"Sud",west:"Ovest",N:"N",NNE:"NNE",NE:"NE",ENE:"ENE",E:"E",ESE:"ESE",SE:"SE",SSE:"SSE",S:"S",SSW:"SSO",SW:"SO",WSW:"OSO",W:"O",WNW:"ONO",NW:"NO",NNW:"NNO"},Te={common:ke,editor:Ve,directions:Ae},De=Object.freeze({__proto__:null,common:ke,editor:Ve,directions:Ae,default:Te}),ze={version:"Version",description:"Zeigt einen Kompass mit einem Indikator in Richtung des Entitätswertes an",invalid_configuration:"Ungültige Konfiguration",no_entity:"Entität nicht konfiguriert",offset_not_a_number:"Richtungs-Offset ist keine Zahl",invalid:"ungültig",on:"An",off:"Aus"},je={name:"Name",optional:"Optional",entity:"Entität",required:"Benötigt",primary:"Richtung",secondary:"Sekundär",indicator:"Indikator",direction:"Richtung",offset:"Offset",show:"Zeige",abbreviations:"Abkürzungen",toggle:"Umschalten",language:"Sprache"},Re={north:"Norden",east:"Osten",south:"Süden",west:"Westen",N:"N",NNE:"NNO",NE:"NO",ENE:"ONO",E:"O",ESE:"OSO",SE:"SO",SSE:"SSO",S:"S",SSW:"SSW",SW:"SW",WSW:"WSW",W:"W",WNW:"WNW",NW:"NW",NNW:"NNW"},Ue={common:ze,editor:je,directions:Re},Ye=Object.freeze({__proto__:null,common:ze,editor:je,directions:Re,default:Ue}),He={version:"version",description:"Montre une boussole avec un indicateur dans la direction de la valeur de l'entité",invalid_configuration:"configuration non valable",no_entity:"entité non configurée",offset_not_a_number:"Le décalage de direction n'est pas un nombre",invalid:"invalide",on:"allumé",off:"éteint"},qe={name:"Nom",optional:"Facultatif",entity:"entité",required:"obligatoire",primary:"primaire",secondary:"secondaire",indicator:"indicateur",direction:"direction",offset:"décalage",show:"montrer",abbreviations:"abréviations",toggle:"basculer",language:"langue"},Ie={north:"Nord",east:"Est",south:"Sud",west:"Ouest",N:"N",NNE:"NNE",NE:"NE",ENE:"ENE",E:"E",ESE:"ESE",SE:"SE",SSE:"SSE",S:"S",SSW:"SSO",SW:"SO",WSW:"OSO",W:"O",WNW:"ONO",NW:"NO",NNW:"NNO"},Fe={common:He,editor:qe,directions:Ie},Le=Object.freeze({__proto__:null,common:He,editor:qe,directions:Ie,default:Fe}),Ze={version:"Versión",description:"Mostrar una brújula con un indicador en la dirección del valor de la entidad",invalid_configuration:"Configuración inválida",no_entity:"Entidad no configurada",offset_not_a_number:"El desplazamiento de dirección no es un número",invalid:"inválido",on:"Encendido",off:"Apagado"},Be={name:"Nombre",optional:"Opcional",entity:"Entidad",required:"Requerido",primary:"Primario",secondary:"Secundario",indicator:"Indicador",direction:"Dirección",offset:"Desplazamiento",show:"Mostrar",abbreviations:"Abreviaturas",toggle:"Conmutar",language:"Idioma"},Je={north:"Norte",east:"Este",south:"Sur",west:"Oeste",N:"N",NNE:"NNE",NE:"NE",ENE:"ENE",E:"E",ESE:"ESE",SE:"SE",SSE:"SSE",S:"S",SSW:"SSO",SW:"SO",WSW:"OSO",W:"O",WNW:"ONO",NW:"NO",NNW:"NNO"},Ke={common:Ze,editor:Be,directions:Je},Ge={version:"versão",description:"Exibe uma bússola com um indicador na direção do valor da entidade",invalid_configuration:"configuração inválida",no_entity:"entidade não configurada",offset_not_a_number:"o offset direcional não é um número",invalid:"inválido",on:"ligado",off:"desligado"},Qe={name:"nome",optional:"opcional",entity:"entidade",required:"necessário",primary:"primário",secondary:"secundário",indicator:"indicador",direction:"direção",offset:"offset",show:"mostra",abbreviations:"abreviações",toggle:"alternar",language:"idioma"},Xe={north:"norte",east:"leste",south:"sul",west:"oeste",N:"N",NNE:"NNE",NE:"NE",ENE:"ENE",E:"L",ESE:"ESE",SE:"SE",SSE:"SSE",S:"S",SSW:"SSO",SW:"SO",WSW:"OSO",W:"O",WNW:"ONO",NW:"NO",NNW:"NNO"},et={common:Ge,editor:Qe,directions:Xe},tt={version:"Versjon",description:"Vis et kompass med en indikator i retning av enhetens verdi",invalid_configuration:"Ugyldig konfigurasjon",no_entity:"Enheten er ikke konfigurert",offset_not_a_number:"Retningsforskyvning er ikke et tall",invalid:"Ugyldig",on:"På",off:"Av"},it={name:"Navn",optional:"Valgfri",entity:"Enhet",required:"Obligatorisk",primary:"Primær",secondary:"Sekundær",indicator:"Indikator",direction:"Retning",offset:"Offset",show:"Vis",abbreviations:"Forkortelser",toggle:"Veksle",language:"Språk"},nt={north:"Nord",east:"Øst",south:"Sør",west:"Vest",N:"N",NNE:"NNØ",NE:"NØ",ENE:"ØNØ",E:"E",ESE:"ESE",SE:"SØ",SSE:"SSE",S:"S",SSW:"SSV",SW:"SV",WSW:"VSV",W:"V",WNW:"VNV",NW:"NV",NNW:"NNV"},ot={common:tt,editor:it,directions:nt};const rt={en:Oe,nl:Me,it:De,de:Ye,es:Object.freeze({__proto__:null,common:Ze,editor:Be,directions:Je,default:Ke}),pt:Object.freeze({__proto__:null,common:Ge,editor:Qe,directions:Xe,default:et}),no:Object.freeze({__proto__:null,common:tt,editor:it,directions:nt,default:ot}),fr:Le},st=[...Object.keys(rt),""].sort();function at(e,t="",i="",n=""){let o;""===n&&(n=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_"));try{o=e.split(".").reduce((e,t)=>e[t],rt[n])}catch(t){o=e.split(".").reduce((e,t)=>e[t],rt.en)}return void 0===o&&(o=e.split(".").reduce((e,t)=>e[t],rt.en)),""!==t&&""!==i&&(o=o.replace(t,i)),o}const ct="mdi:compass",dt={N:0,NNE:22.5,NE:45,ENE:67.5,E:90,ESE:112.5,SE:135,SSE:157.5,S:180,SSW:202.5,SW:225,WSW:247.5,W:270,WNW:292.5,NW:315,NNW:337.5},lt=[at("directions.N"),at("directions.NNE"),at("directions.NE"),at("directions.ENE"),at("directions.E"),at("directions.ESE"),at("directions.SE"),at("directions.SSE"),at("directions.S"),at("directions.SSW"),at("directions.SW"),at("directions.WSW"),at("directions.W"),at("directions.WNW"),at("directions.NW"),at("directions.NNW")],ut=at("common.invalid"),pt=["arrow_inward","arrow_outward","circle"].sort(),ht=["sensor","input_number","input_text"];let ft=class extends te{setConfig(e){this._config=e}get _name(){return this._config&&this._config.name||""}get _entity(){return this._config&&this._config.entity||""}get _secondary_entity(){return this._config&&this._config.secondary_entity||""}get _direction_offset(){return this._config&&this._config.direction_offset||"0"}get _compass_indicator(){var e,t,i,n;return console.log(null===(t=null===(e=this._config)||void 0===e?void 0:e.compass)||void 0===t?void 0:t.indicator,pt[1]),this._config&&(null===(n=null===(i=this._config)||void 0===i?void 0:i.compass)||void 0===n?void 0:n.indicator)||pt[1]}get _compass_show_north(){var e,t;return this._config&&(null===(t=null===(e=this._config)||void 0===e?void 0:e.compass)||void 0===t?void 0:t.show_north)||!1}get _compass_language(){var e,t;return this._config&&(null===(t=null===(e=this._config)||void 0===e?void 0:e.compass)||void 0===t?void 0:t.language)||""}render(){if(!this.hass)return D``;const e=Object.keys(this.hass.states).filter(e=>ht.includes(e.substr(0,e.indexOf(".")))).sort();return D`
      <div class="card-config">
        <paper-input label="${at("editor.name")} (${at("editor.optional")})" .value=${this._name} .configValue=${"name"} @value-changed=${this._valueChanged}></paper-input>
        <paper-dropdown-menu class="editor-entity-select" label="${at("editor.primary")} ${at("editor.entity")} (${at("editor.required")})" @value-changed=${this._valueChanged} .configValue=${"entity"}>
          <paper-listbox slot="dropdown-content" .selected=${e.indexOf(this._entity)}>
            ${e.map(e=>D` <paper-item>${e}</paper-item> `)}
          </paper-listbox>
        </paper-dropdown-menu>
        <paper-dropdown-menu class="editor-entity-select" label="${at("editor.secondary")} ${at("editor.entity")} (${at("editor.optional")})" @value-changed=${this._valueChanged} .configValue=${"secondary_entity"}>
          <paper-listbox slot="dropdown-content" .selected=${e.indexOf(this._secondary_entity)}>
            ${e.map(e=>D` <paper-item>${e}</paper-item> `)}
          </paper-listbox>
        </paper-dropdown-menu>
        <paper-dropdown-menu class="editor-entity-select" label="${at("editor.indicator")} (${at("editor.optional")})" @value-changed=${this._valueChanged} .configValue=${"compass.indicator"}>
          <paper-listbox slot="dropdown-content" .selected=${pt.indexOf(this._compass_indicator)}>
            ${pt.map(e=>D` <paper-item>${e}</paper-item>`)}
          </paper-listbox>
        </paper-dropdown-menu>
        <paper-dropdown-menu
          class="editor-entity-select"
          label="${at("editor.direction")} ${at("editor.abbreviations")} ${at("editor.language")} (${at("editor.optional")})"
          @value-changed=${this._valueChanged}
          .configValue=${"compass.language"}
        >
          <paper-listbox slot="dropdown-content" .selected=${st.indexOf(this._compass_language)}>
            ${st.map(e=>D` <paper-item>${e}</paper-item>`)}
          </paper-listbox>
        </paper-dropdown-menu>
        <paper-input label="${at("editor.direction")} ${at("editor.offset")} (${at("editor.optional")})" .value=${this._direction_offset} @value-changed=${this._valueChanged} .configValue=${"direction_offset"}></paper-input>
        <div class="floated-label-placeholder">${at("editor.show")} ${at("directions.north")}</div>
        <ha-switch
          aria-label=${`${at("editor.toggle")} ${at("directions.north")} ${this._compass_show_north?at("common.off"):at("common.on")}`}
          .checked=${!1!==this._compass_show_north}
          .configValue=${"compass.show_north"}
          @change=${this._valueChanged}
          >${at("editor.show")} ${at("directions.north")}</ha-switch
        >
      </div>
    ...
    `}};var mt;e([J({attribute:!1})],ft.prototype,"hass",void 0),e([J({attribute:!1,hasChanged:null==mt?void 0:mt.hasChanged})],ft.prototype,"_config",void 0),ft=e([Z("compass-card-editor")],ft);const gt=X`
...
`;var _t;console.info(`%c  COMPASS-CARD \n%c  ${at("common.version")} 0.3.1    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"compass-card",name:"Compass Card",preview:!0,description:at("common.description")});let vt=_t=class extends te{static async getConfigElement(){return document.createElement("compass-card-editor")}static getStubConfig(){return{entity:"",secondary_entity:"",direction_offset:0,name:"Compass Card"}}setConfig(e){if(!e)throw new Error(at("common.invalid_configuration"));e.test_gui&&function(){var e=document.querySelector("home-assistant");if(e=(e=(e=(e=(e=(e=(e=(e=e&&e.shadowRoot)&&e.querySelector("home-assistant-main"))&&e.shadowRoot)&&e.querySelector("app-drawer-layout partial-panel-resolver"))&&e.shadowRoot||e)&&e.querySelector("ha-panel-lovelace"))&&e.shadowRoot)&&e.querySelector("hui-root")){var t=e.lovelace;return t.current_view=e.___curView,t}return null}().setEditMode(!0),this._config=Object.assign({},e)}shouldUpdate(e){if(e.has("_config"))return!0;if(this._config.entity){const t=e.get("hass");if(t&&t.states[this._config.entity]!==this.hass.states[this._config.entity])return!0}if(this._config.secondary_entity){const t=e.get("hass");if(t&&t.states[this._config.secondary_entity]!==this.hass.states[this._config.secondary_entity])return!0}return!1}render(){if(!this._config||!this.hass)return D``;let e=0;Number.isNaN(Number(this._config.direction_offset))||(e=_t.positiveDegrees(+this._config.direction_offset));const t=this.hass.states[this._config.entity],i=this._config.secondary_entity?this.hass.states[this._config.secondary_entity]:void 0,n=t?t.attributes.friendly_name:this._config.entity;return D`
    ...
    `}renderCompass(e,t,i){var n,o,r;let s=0,a=at("common.invalid");const c=e?e.state:ut;if(Number.isNaN(Number(c))){if(s=_t.getDegrees(c),a=c,-1===s){const e=c.replace(/\s+/g,"").match(/[+-]?\d+(\.\d)?/);s=(null==e?void 0:e.length)?_t.positiveDegrees(parseFloat(e[0])):0,a=_t.getCompassAbbreviation(s,null===(n=this._config.compass)||void 0===n?void 0:n.language)}}else s=_t.positiveDegrees(parseFloat(c)),a=_t.getCompassAbbreviation(s,null===(o=this._config.compass)||void 0===o?void 0:o.language);return D`
      <div class="compass">
        ...
        <div class="indicator ${_t.computeIndicator(this._config)}" style="transform: rotate(${(s+i)%360}deg)"></div>
        ${(null===(r=this._config.compass)||void 0===r?void 0:r.show_north)?D`<div class="indicator north" style="transform: rotate(${_t.positiveDegrees(i)}deg)"></div>`:""}
      </div>
    `}getConfigStyle(e){return e&&e.style_css?e.style_css:""}renderHeader(){return this.computeName()?D`
        <div class="header">
          <div class="name">
      ...
      `:""}getCardSize(){return 4}computeName(){if(this._config.name&&this._config.name.trim().length>0)return this._config.name}computeIcon(){const e=this.hass.states[this._config.entity];return e&&e.attributes.icon?e.attributes.icon:ct}static get styles(){return gt}static computeIndicator(e){return e.compass&&e.compass.indicator&&pt.indexOf(e.compass.indicator)>=0?e.compass.indicator:pt[1]}static getDegrees(e){return dt[e]?dt[e]:-1}static getCompassAbbreviation(e,t){const i=Math.round(_t.positiveDegrees(e)/22.5);let n="N";return i>15&&(n=lt[0]),n=lt[i],at("directions."+n,"","",t)}static positiveDegrees(e){return e<0?e+360*(Math.abs(Math.ceil(e/360))+1):e%360}};e([J({attribute:!1})],vt.prototype,"hass",void 0),e([J({attribute:!1})],vt.prototype,"_config",void 0),vt=_t=e([Z("compass-card")],vt);export{vt as CompassCard};
