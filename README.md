...
| value_sensors     | Array of [value sensors object](#value-sensors-object)         | **Optional** | v1.0.0    | See [value sensors object](#value-sensors-object)         | Entities to show under the direction in compass                                                            |
...
| double_tap_action | [action config object](#action-config-object)                  | **Optional** | v2.1.0    | See [action config object](#action-config-object)         | Double tap action settings (what happens when you double click/touch the card)                             |
